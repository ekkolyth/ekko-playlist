...
function DashboardPage() {
  ...
  const [selectModeActions, setSelectModeActions] = useState<React.ReactNode>(null);
    ...
    <div className='flex-1 p-6'>
      <div className='container mx-auto max-w-7xl'>
        ...
        <VideoCollection
          ...
          isLoading={isLoading}
          error={error}
          emptyTitle={selectedChannels.length > 0 ? 'No videos match your filters' : 'No videos yet'}
          emptyDescription={
